const fs = require('fs'),
    ...
    filePathToFetchCalendar = path.join("Rodrigo Franco's Notes — Primary Interests_Calendar.html"), // Iteration here for multiple files
    filePathToSaveCalendar = path.join("Rodrigo Franco's Notes — Primary Interests.html")
